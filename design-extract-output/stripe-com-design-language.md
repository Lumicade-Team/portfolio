...
> Extracted from `https://stripe.com/en-my` on May 1, 2026
> 2444 elements analyzed
...
| Secondary | `#e8e9ff` | rgb(232, 233, 255) | hsl(237, 100%, 95%) | 57 |
...
| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#000000` | hsl(0, 0%, 0%) | 2664 |
| `#50617a` | hsl(216, 21%, 40%) | 320 |
...
Used on large-area elements: `#ffffff`, `#e5edf5`, `#f8fafd`, `#302554`, `#0d1738`, `#f2f7fe`
...
```css
background-image: linear-gradient(0deg, rgb(255, 46, 222), rgb(210, 152, 255));
```
...
- **sohne-var** — used for all (2444 elements)
...
**53 grid containers** and **378 flex containers** detected.
...
- 6088 duplicate CSS declarations
...
|-------|-------|----------|
| base | -1,3 | div.n.a.v.i.g.a.t.i.o.n.-.m.e.n.u._._.b.a.c.k.g.r.o.u.n.d, div.s.e.s.s.i.o.n.s.-.k.e.y.n.o.t.e.-.s.p.e.a.k.e.r.-.i.m.a.g.e, div.s.e.s.s.i.o.n.s.-.k.e.y.n.o.t.e.-.s.p.e.a.k.e.r.-.i.m.a.g.e |
...
**82 unique SVG icons** detected. Dominant style: **filled**.
...
**Aspect ratios:** 4.18:1 (36x), 3:4 (8x), 21:9 (8x), 1:1 (7x), 9:16 (4x), 2:3 (4x), 4:3 (2x), 16:9 (2x)
...
|---|---|---|
| default | 172 | Accept and optimise payments globally –  |
...
Reading order (top→bottom): cta → nav → nav → nav → pricing-table → hero → pricing-table → testimonial → stats → pricing-table → testimonials → nav → pricing-table → nav → gallery → testimonial → nav → content → pricing-table → pricing-table → gallery → cta → footer
...
| 5 | hero | Financial infrastructure to grow your revenue. Accept payments, offer financial  | 0.85 |
...
| 10 | testimonials | Transform your enterprise with agile financial infrastructure | 0.4 |
| 11 | nav | Transform your enterprise with agile financial infrastructure | 0.4 |
...
| 17 | content | Reliable, extensible infrastructure for every stack. | 0.3 |
...
**Label:** `flat-illustration` (confidence 0.267)
**Counts:** total 75, svg 43, icon 1, screenshot-like 0, photo-like 2
