...
url: "https://stripe.com/en-my"
generated_at: "2026-05-01T11:58:35.866Z"
...
Reading order detected on the source: `cta → nav → nav → nav → pricing-table → hero → pricing-table → testimonial → stats → pricing-table → testimonials → nav → pricing-table → nav → gallery → testimonial → nav → content → pricing-table → pricing-table → gallery → cta → footer`.

Source: <https://stripe.com/en-my>.
...
**Layout primitives:** 53 grid containers · 378 flex containers.
...
- Don't 6088 duplicate css declarations.

---
_Generated by [designlang](https://github.com/Manavarya09/design-extract) v12.1.0 from <https://stripe.com/en-my>._
