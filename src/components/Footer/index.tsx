  ...
  return (
    <footer className="bg-surface border-t border-outline-variant/15">
        ...
        <div className="md:col-span-1">
          ...
          <ul className="space-y-4">
            <li>
              <Link
                href="/#services"
                className="font-body text-sm text-on-surface-variant hover:text-primary transition-colors duration-sm ease-out-stripe"
              >
                Services
              </Link>
            </li>
          ...
          <ul className="space-y-4">
            <li>
              <a
                ...
                className="font-body inline-flex items-center gap-2 text-sm text-on-surface-variant hover:text-primary transition-colors duration-sm ease-out-stripe"
              >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-8 border-t border-outline-variant/10 text-center md:text-left">
        <p className="font-body text-xs text-on-surface-variant opacity-80 hover:opacity-100 transition-all duration-sm ease-out-stripe">
