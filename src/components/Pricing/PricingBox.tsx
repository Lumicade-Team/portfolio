      ...
      <div className="shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark relative z-10 rounded-xs bg-white px-8 py-10">
        <div className="flex items-center justify-between">
          <h3 className="price mb-2 text-[32px] font-bold text-black dark:text-white">
            ...
            <span className="time text-body-color dark:text-body-color-dark text-lg font-medium">
              /{duration}
            </span>
          </h3>
        ...
        <p className="text-body-color dark:text-body-color-dark mb-7 text-base">{subtitle}</p>
