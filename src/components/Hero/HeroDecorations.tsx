  ...
  <>
    <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
      ...
      >
        ...
        <circle
          cx="325.486" cy="302.87" r="180"
          transform="rotate(-37.6852 325.486 302.87)"
          fill="url(#paint3_linear_25:217)"
        />
        <circle
          opacity="0.8" cx="184.521" cy="315.521" r="132.862"
          transform="rotate(114.874 184.521 315.521)"
          stroke="url(#paint4_linear_25:217)"
        />
        <circle
          opacity="0.8" cx="356" cy="290" r="179.5"
          transform="rotate(-30 356 290)"
          stroke="url(#paint5_linear_25:217)"
        />
        <circle
          opacity="0.8" cx="191.659" cy="302.659" r="133.362"
        ...
        <defs>
          ...
          <radialGradient id="paint1_radial_25:217" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(17.9997 182) rotate(90) scale(18)">
            <stop offset="0.145833" stopColor="#3352DA" stopOpacity="0" />
            <stop offset="1" stopColor="#3352DA" stopOpacity="0.08" />
          </radialGradient>
          <radialGradient id="paint2_radial_25:217" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(76.9997 288) rotate(90) scale(34)">
            <stop offset="0.145833" stopColor="#229D94" stopOpacity="0" />
            <stop offset="1" stopColor="#229D94" stopOpacity="0.08" />
          </radialGradient>
          <linearGradient id="paint3_linear_25:217" x1="226.775" y1="-66.1548" x2="292.157" y2="351.421" gradientUnits="userSpaceOnUse">
            <stop stopColor="#229D94" />
            <stop offset="1" stopColor="#229D94" stopOpacity="0" />
          </linearGradient>
    ...
    <div className="absolute bottom-0 left-0 z-[-1] opacity-30 lg:opacity-100">
      ...
      >
        ...
        />
        <circle
          opacity="0.8" cx="214.505" cy="60.5054" r="49.7205"
        ...
        <defs>
          <linearGradient id="paint0_linear_25:218" x1="184.389" y1="69.2405" x2="184.389" y2="212.24" gradientUnits="userSpaceOnUse">
            <stop stopColor="#3352DA" stopOpacity="0" />
            <stop offset="1" stopColor="#3352DA" />
          </linearGradient>
